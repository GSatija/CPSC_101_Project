...
public class GuiHandler {
    ...
    public void createWindow(Player p1, Player p2) {
        ...
        textBox.setBounds(0, 0, 200, 50);
        textBox.setWrapStyleWord(true);
        textBox.setEditable(false);

        JLabel whiteBead = new JLabel(new ImageIcon("images\\beadWhite.png"));
        JLabel blackBead = new JLabel(new ImageIcon("images\\beadBlack.png"));
