...
public class PaintComponent extends JComponent implements MouseListener {
    ...
    public void findPeg(int x, int y) {
        ...
        if (noClick == true) {
            ...
            System.out.println("Sumbit move");
        }
    }
