...
public class Bead {
    ...
    public void drawWhite(Graphics g, int x, int y) throws IOException {
        ...
        myX = x;
        myY = y;
        bead = ImageIO.read(new File("/Users/gauravsatija/IdeaProjects/ca_unbc_cpsc_caffine/src/ca/unbc/cpsc/score4/images/beadWhite.png"));
        g2.drawImage(bead, myX - 20, myY - 20, null);
    }

    public void drawBlack(Graphics g) throws IOException {
        Graphics2D g2 = (Graphics2D) g;
        bead = ImageIO.read(new File("/Users/gauravsatija/IdeaProjects/ca_unbc_cpsc_caffine/src/ca/unbc/cpsc/score4/images/beadBlack.png"));
        g2.drawImage(bead, myX - 20, myY - 20, null);
